...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        add_or_load_seedlot(join(dirpath, 'SeedLots_magic.xlsx'))
        prev_time = print_duration('SeedLots_magic.xlsx', prev_time)

        add_or_load_crosses_data(join(dirpath, 'varitome_crosses_all.xlsx'),
